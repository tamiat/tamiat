<template>
  <div class="container posts" id="posts" v-if="loaded">
    ...
    <div class="content-heading is-flex">
      <h3 class="is-size-3">{{ customContent.name }}</h3>
      <router-link :to="`${customContent.path}/new`" class="button is-info">Add New</router-link>
    </div>
    ...
    <router-view :supports="customContent.supports"></router-view>
